...
class PeerMessage implements Serializable
{
    ...
    public String toString()
    {
        return "(" + getClass().toString() + ", " + Source.toString() + ", " + Timestamp.toString() + ")";
    }
}
...
class PeerClientMessage extends PeerMessage implements Serializable
{
    ...
    public String toString()
    {
        return "(" + getClass().toString() + ", " + Source.toString() + ", " + Timestamp.toString() + ", " + Data.toString() + ")";
    }
}
...
class NewPeerACK extends PeerACK implements Serializable
{
    ...
    public String toString()
    {
        return "(" + "NewPeerACK, " + Source.toString() + ", " + Timestamp.toString() + ", ORIGINAL_TIME = " + OriginalTimestamp.toString() + ", InitialState = " + InitialState.toString() + ")";
    }
}
...
class NewPeerMessage extends PeerMessage implements Serializable
{
    ...
    public String toString()
    {
        return "(" + this.getClass().toString() + ", " + Source.toString() + ", " + Timestamp.toString() + ", " + PeerCount.toString() + ")";
    }
}
