...
public class MazewarServer implements Runnable, INetworkServer, ITOMRecipient
{
    ...
    public MazewarServer (int myPort, INetworkPeer listener, String peerHost, int peerPort)
        throws IOException, ClassNotFoundException, InterruptedException
    {
        _ServerSocket = new ServerSocket(myPort);
        _Owner = listener;
    ...
    public void broadcastMessage (Object data)
        throws IOException, ClassNotFoundException, InterruptedException
    {
        if (!_LocalMessageQueue.offer(new PeerClientMessage(Me, data)))
    ...
    private synchronized void dispatchNewPeer (NewPeerMessage msg)
        throws IOException, ClassNotFoundException
    {
        NewPeerACK ack = new NewPeerACK(Me, msg.Timestamp, msg, _Owner.getCurrentState());
        int numAcks;
        if (_StillJoining)
        {
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        else
        {
            ...
            _Owner.onNewPeerJoin(_InitialPeerData.get(_IncomingPeer));
        }
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        sendMessage(new PeerClientACK(Me, msg));
    }
