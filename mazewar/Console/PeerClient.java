...
public class PeerClient
{
	...
	{
        System.out.println("SEND[ " + Server.toString() + ", " + msg.toString() + " ]");
        ...
        {
            throw new IllegalArgumentException("Server did not respond with PeerMessage of EMPTY type.");
        }
    }
        ...
        throws IOException, ClassNotFoundException
    {
        if (isConnected())
        {
            sendMessage(new PeerMessage(Me, -1, PeerMessageID.GOODBYE));
        }
