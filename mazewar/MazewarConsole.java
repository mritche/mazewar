...
public class MazewarConsole implements INetworkPeer
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            // Local client.
            MazewarConsole console = new MazewarConsole();

            // Local server. Attach it to the console.
            INetworkServer server = new MazewarServer(myPort, console);
            ...
            if (args.length == 4)
        	{
                ...
                server.connectToPeer(peerHost, peerPort);
            }

            console.sendMessage("Hello from " + myName);
        }
        catch (Exception e)
        {
            e.printStackTrace();
