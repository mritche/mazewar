...
public class MazewarServer implements Runnable, INetworkServer, ITOMRecipient
{
    ...
    private boolean _LocalQueueReady = false;
    private final Semaphore _LocalQueueLock = new Semaphore(1);
        ...
        throws IOException, ClassNotFoundException, InterruptedException
    {
        ...
        queueMessageForBroadcast(new NewPeerMessage(source, _Peers.size()));
    }
